...
const newCard = ({ id, imageUrl, blogTitle, blogType, blogDescription })=>`<div class="col-lg-4 col-md-6" id=${id}>
<div class="card m-2">
...
const deleteCard = (event)=>{
    ...
    if (tagname === "BUTTON") // task__container
    return blogContainer.removeChild(event.target.parentNode.parentNode.parentNode // col-lg-4
    );
    // else
    // blog__container
    return blogContainer.removeChild(event.target.parentNode.parentNode.parentNode.parentNode // col-lg-4
    );
};
...
const editCard = (event)=>{
    ...
    let parentElement;
    if (tagname === "BUTTON") parentElement = event.target.parentNode.parentNode;
